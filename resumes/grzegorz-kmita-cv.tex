...
\section{Projekty}
    ...
    {\underline{GitHub}}} $|$ \emph{HTML, CSS, JavaScript, Git, Vercel}}{2020 -- Teraz}
          \resumeItemListStart
            \resumeItem{Utworzyłem personalną stronę typu portfolio z minimalistycznym front-endem}
            ...
            \resumeItem{Stworzyłem podstronę poświęconą chińskim słowom używanych w grze Teamfight Tactics.}
            \resumeItem{Dodałem grafikę reprezentującą przedmioty w grze i ich nazwy, jak i popularne słownictwo używane przez Chińczyków}
          \resumeItemListEnd
      \resumeProjectHeading
            %Square Madness%
    ...
    {\underline{GitHub}}}  $|$ \emph{Python, turtle, Git}}{Lut 2022}
        ...
        \resumeItem{Zaprogramowałem poruszanie się, system kolizji, combo i system punktów.}
    ...
    {\underline{GitHub}}} $|$ \emph{C, Git}}{Sty 2023}
      ...
      \resumeItemListEnd
\resumeProjectHeading
       {\textbf {Program zarządzający danymi osobistymi z listy} $|$ {\href{https://github.com/jirafey/pong}
    {\underline{GitHub}}} $|$ \emph{C, Git}}  {Lut 2023}
          \resumeItemListStart
                  \resumeItem{Zbudowałem program na strukturze listy dwukierunkowej. Wykorzystałem dynamiczną alokację pamięci.}
        \resumeItem{Zaimplementowałem dodawanie/usuwanie/zapisywanie do pliku/wczytywanie z pliku/sortowanie (bąbelkowe)/szukanie.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Języki}{: Python, C/C++, HTML/CSS, JavaScript, {C{\#}}, Rust, Matlab, Arduino} \\
     \textbf{Technologie}{: Access, Excel, Github, Git, Vercel, VS Code, Visual Studio, PyCharm, CLion, Unity, Markdown, LaTeX} \\
     \textbf{Biblioteki}{: pygame, turtle, NumPy, Pandas, Scikit-learn}
    }}
\end{itemize}
\section{Języki obce}
